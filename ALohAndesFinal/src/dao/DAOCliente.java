...
public class DAOCliente 
{
	...
	*/
	...
	public Cliente findClienteByLogin(String login) throws SQLException, Exception 
	{
		...
		String sql = String.format("SELECT * FROM %1$s.BEBEDORES WHERE LOGIN = %5$d", USUARIO, login); 
	...
	public Cliente findClienteById(int id) throws SQLException, Exception 
	{
		...
		String sql = String.format("SELECT * FROM %1$s.BEBEDORES WHERE IDCLIENTE = %2$d", USUARIO, id); 
	...
	public void addCliente(Cliente cliente) throws SQLException, Exception {
		...
		String sql = String.format("INSERT INTO %1$s.BEBEDORES (IDCLIENTE, NOMBRE, APELLIDO, LOGIN,PASSOWRD) VALUES (%2$s, '%3$s', '%4$s', '%5$s','%6$s')", 
									USUARIO, 
